...
- **`specs/archive/`**: The retired TypeScript execution gateway documentation. **DO NOT modify.** Historical reference only. (Was: `specs/07-Claw-OS.md`, now superseded by `specs/25-OpenCode-Integration.md`)
...
- [ ] specs/07-OpenClaw-OS.md — [affected / not affected, and why] (ARCHIVED)
